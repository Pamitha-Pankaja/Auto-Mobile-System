...
import leftIcon from '../assets/images/whychooseus-left-img.png';
        ...
        <section className="whychoose-section overflow-hidden">
            <div className="container">
                <div className="row">
                    <div className="col-12">
                        <h6 className="autorix-text">
                            <img src={textIcon} alt="Why Choose Us Left Icon" />
                             Why choose us
                        </h6>
                ...
                <div className="row">
                    ...
                    <div className="col-lg-3 col-md-4 col-sm-6 mb-md-0 mb-0 text-center">
                        <div
                            className="blogs-section"
                            data-aos="fade-right"
                            data-aos-offset="300"
                        ...
                        >
                            <div className="images-blog">
                                <figure className="mb-0">
                                    <img className="img-fluid" src={img3} alt="Long term warranty" />
                                </figure>
                            </div>
                            <h5 className="blogs-h5">Long Term Warranty</h5>
                            <p className="blogs-p">
                                Suis autem velaum iure reare aenderit rui in ea roluptate velit esse ruam moles nulla
                            </p>
                            <div className="read-more">
                                <a href="aboutus.html" className="text-decoration-none">
                                    Read more <i className="fa-solid fa-arrow-right"></i>
